...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Entire JSON document</td>
    </tr>
    <tr>
      <td>
        <code>$.store</code>
      </td>
      <td>Complete store object</td>
    </tr>
    <tr>
      <td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>First and third books</td>
    </tr>
    <tr>
      <td>
        <code>$.store.books[0:2]</code>
      </td>
      <td>Index 0-1 (slice)</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>All titles (recursive)</td>
      <td>Requires recursive function</td>
      <td>
        <code>$..title</code>
      </td>
    </tr>
